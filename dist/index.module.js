import React, { memo, forwardRef, useRef, useEffect, useState, useLayoutEffect } from 'react';
...
var VideoControls = /*#__PURE__*/React.memo(function (props) {
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    tabIndex: "0"
  }, formatTime(Number(props.currentTime))), props.captions && /*#__PURE__*/React.createElement(BaseButton$1, {
    className: "VideoControls-button",
...
var VideoPlayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function render() {
      ...
      }), this.props.captions && /*#__PURE__*/React.createElement("div", {
        className: "VideoPlayer-captions-container",
        ref: function ref(r) {
          return _this3.captionsContainer = r;
        }
      }, this.state.currentCaptions && /*#__PURE__*/React.createElement("p", null, this.state.currentCaptions)), this.props.hasControls && /*#__PURE__*/React.createElement(VideoControls, {
...
export { BaseButton$1 as BaseButton, BaseLink$1 as BaseLink, CloseButton$1 as CloseButton, Footer$1 as Footer, HamburgerButton$1 as HamburgerButton, HamburgerMenu$1 as HamburgerMenu, MainTopNav$1 as MainTopNav, PageOverlay$1 as PageOverlay, RotateScreen$1 as RotateScreen, VideoPlayer };
